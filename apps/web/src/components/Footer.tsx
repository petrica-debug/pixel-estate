        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="text-xs leading-5 text-zinc-500">
              Fractional real estate ownership through NFT pixel shares on Polygon.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li><Link href="/properties" className="text-xs text-zinc-500 hover:text-white">Properties</Link></li>
              <li><Link href="/marketplace" className="text-xs text-zinc-500 hover:text-white">Marketplace</Link></li>
              <li><Link href="/portfolio" className="text-xs text-zinc-500 hover:text-white">Portfolio</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">Documentation</Link></li>
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">Whitepaper</Link></li>
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">Smart Contracts</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-400">Legal</h3>
            <ul className="mt-3 space-y-2">
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">Terms of Service</Link></li>
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">Privacy Policy</Link></li>
              <li><Link href="#" className="text-xs text-zinc-500 hover:text-white">KYC/AML Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className="mt-10 border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-zinc-600">&copy; 2026 PixelEstate. All rights reserved.</p>
